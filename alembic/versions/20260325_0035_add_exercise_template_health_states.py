"""add exercise template health states
...
def upgrade() -> None:
    op.create_table(
        "exercise_template_health_states",
    ...
    op.create_index(
        "idx_exercise_template_health_states_status",
        "exercise_template_health_states",
...
def downgrade() -> None:
    op.drop_index("idx_exercise_template_health_states_status", table_name="exercise_template_health_states")
    op.drop_table("exercise_template_health_states")
