...
class PostgresVocabularyRepository:
    ...
    def list_all_sync(self, *a, **k): return self._run(self.list_all(*a, **k))
    def list_due_sync(self, *a, **k): return self._run(self.list_due(*a, **k))
    def get_sync(self, *a, **k): return self._run(self.get(*a, **k))
    def exists_sync(self, *a, **k): return self._run(self.exists(*a, **k))
    def update_sync(self, *a, **k): return self._run(self.update(*a, **k))
    def update_enrichment_sync(self, *a, **k): return self._run(self.update_enrichment(*a, **k))
