...
class DailyMissionRepository(Protocol):
    ...
    async def mark_completed_once(self, mission_id: int, *, completed_at: datetime) -> tuple[Any, bool]: ...
...
class RewardChestRepository(Protocol):
    ...
    async def mark_unlocked_once(self, chest_id: int, *, unlocked_at: datetime) -> tuple[Any, bool]: ...
    async def mark_claimed_once(self, chest_id: int, *, claimed_at: datetime) -> tuple[Any, bool]: ...
